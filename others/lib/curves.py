...
def qlOIS():
    ...
    df = pd.read_excel(r'lib/project_data.xlsx',sheet_name='ois')
...
def qlLibor3mSwap(discount_curve):
        ...
        df = pd.read_excel(r'lib/project_data.xlsx',sheet_name='3m libor')
...
def qlLibor6mSwap(discount_curve):
        ...
        df = pd.read_excel(r'project_data.xlsx',sheet_name='6m libor')
...
def test_cds():
    df = pd.read_excel(r'project_data.xlsx',sheet_name='jpm cds', index_col = 'Tenor')
